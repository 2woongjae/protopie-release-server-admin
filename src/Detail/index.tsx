...
export default class Detail extends React.Component<DetailProps, {}> {
    render() {
        if (this.props.platform === 'darwin') {
            const version: VersionDarwin = this.props.darwins.filter(v => v.version === this.props.version)[0];
            ...
            const version: VersionWin32 = this.props.win32s.filter(v => v.version === this.props.version)[0];
